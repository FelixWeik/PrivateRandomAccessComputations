...
/* Both implementations are based on reference code from the Intel AES-NI whitepaper
...
static void AES_128_Key_Expansion (AESkey &key, __m128i rawkey)
{
    __m128i temp1, temp2;
...
static void AES_ECB_encrypt(__m128i &ciphertext, __m128i plaintext,
